        ...
        layout = [
            ...
            [
                sg.Column([
                    ...
                    [
                        sg.Radio('Market', "RADIO1", default=self.conf_dict["radio_market"], key="radio_market", size=(10,1)), 
                        sg.Checkbox('Market Lock', default=False, key="market_lock", enable_events=True)
                    ],
                    [
                        sg.Radio('Stop Market', "RADIO1",key="radio_stop_market", size=(10,1)), 
                        sg.Radio('Take Profit', "RADIO1", key="radio_take_profit", size=(10, 1)),
                        sg.Radio('Trailing Stop Loss', "RADIO1",key="radio_tls", size=(14,1))
                    ],
                    [sg.Text("")], 
                    [
                ...
                sg.Column([
                        [sg.Button(c[:-4], key="-"+c+"-", size=(10, 1)) for c in self.currencies],
                        ...
                        [
                            ...
                            sg.Button("Reset", size=(10, 1), key="-applyrate-"), 
                            # sg.Text(), 
                            sg.Checkbox("Convert USDT", default=True, key="toggle_USDT"),
                            
                        ],
                        [sg.Button(key=d, size=(10 ,1), button_text="- . -- %") for d in self.currencies],
                        [
