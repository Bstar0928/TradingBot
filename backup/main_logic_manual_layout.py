...
class Main_window():
    ...
    def get_layout(self):
        ...
        layout = [
            ...
            [
                sg.Column([
                    [
                        sg.Text("BALANCE:", size =(14, 1), background_color="#323233"), 
                        sg.Text("", key="balance", size=(10, 1), background_color="#323233"), 
                        sg.Text("Liquidation Price:", size =(14, 1), background_color="#323233"), 
                        sg.Text("", key="liquidationPrice", size=(10, 1), background_color="#323233")
                    ],
                    [
                        sg.Text("Margin Balance:", size =(14, 1), background_color="#323233"), 
                        sg.Text("", key="margin", size=(10, 1), background_color="#323233"), 
                        sg.Text("Maintence Margin:", size =(14, 1), background_color="#323233"), 
                        sg.Text("", key="maintence", size=(10, 1), background_color="#323233")
                    ],
                    [
                        sg.Text("Unrealized PNL:", size =(14, 1), background_color="#323233"), 
                        sg.Text("", key="PNL", size=(10, 1), background_color="#323233")
                    ],  
                    [
                        sg.Text("Symbol: ", size =(11, 1), background_color="#323233"),
                        sg.In(default_text=self.conf_dict["symbol"][:-4], size=(11, 1), key="symbol"), 
                        sg.Checkbox('Symbol Lock', default=False, key="symbol_lock", size =(12, 1), background_color="#323233"), 
                        sg.Button("Change", key="-symbol-", size =(10, 1))
                    ],
                    [
                        sg.Radio('Crossed', 'margin', default=(not self.conf_dict["Isolated"]), size=(10, 1), background_color="#323233"),
                        sg.Radio('Isolated', 'margin', key="Isolated", default=self.conf_dict["Isolated"], size=(10, 1), background_color="#323233")
                    ],
                    ...
                    [
                        sg.Text("Reduce-only", size =(9, 1), background_color="#323233"), 
                        sg.Checkbox("", size=(1, 1), default=self.conf_dict["reduce"], key="reduce", background_color="#323233"), 
                        sg.Text('    Leverage: ', size =(9, 1), background_color="#323233"), 
                        sg.Spin(values=[i for i in range(1, 126)], key="leverage", initial_value=self.conf_dict["leverage"], size=(6, 1))
                    ],
                    
                    
                    [
                        sg.Radio('Amount ', "RADIO2", size=(10, 1), default=True, key="amount_value", background_color="#323233"), 
                        sg.Radio('Exact Price ', "RADIO2", size=(10, 1), key="price_value", background_color="#323233"), 
                        sg.Radio('Percentage ', "RADIO2", key="percentage_value", background_color="#323233")
                    ], 
                    [
                        sg.Button('Long',key='-???-', size=(8, 1)), ##sg.Button('Short',key='-short2-', size=(8, 1)), 
                        sg.Text("Percentage", background_color="#323233") , 
                        sg.Spin(values=[i/10 for i in range(1,51)], key="percentage_tls",initial_value=self.conf_dict["callback_rate"], size=(4, 1)),
                        sg.Text("Callback", background_color="#323233") , 
                        sg.Spin(values=[i/10 for i in range(1,51)], key="callback_rate",initial_value=self.conf_dict["callback_rate"], size=(4, 1))
                    ],
                    [
                        sg.Radio('Market', "RADIO1", default=self.conf_dict["radio_stop_market"], size=(6,1), key="radio_market", background_color="#323233"), 
                        sg.Checkbox('Market Lock', default=False, key="market_lock", enable_events=True, background_color="#323233")
                    ],
                    [
                        sg.Radio('Stop Market', "RADIO1",key="radio1", default=self.conf_dict["radio_stop_market"], size=(10,1), background_color="#323233"), 
                        sg.Radio('Take Profit', "RADIO1", key="radio2", default=self.conf_dict["radio_take_profit"], size=(10, 1), background_color="#323233"),
                        sg.Radio('Trailing Stop Loss', "RADIO1",key="radio3", default=self.conf_dict["radio_tls"], size=(14,1), background_color="#323233")
                    ],
                    [
                ...
                sg.Column([
                        ...
                        [
                            sg.Text("Rate of change ", background_color="#323233"), 
                            sg.In(key="rate", default_text=self.conf_dict["rate"], size=(3,1)), 
                            sg.Radio("Sec","radio_rate", key="sec_rate", default=self.conf_dict["sec_rate"], background_color="#323233"),
                            sg.Radio("Min","radio_rate", key="min_rate", background_color="#323233"), 
                            sg.Checkbox("Reverse Lock", size=(10, 1), key="-reverse-", enable_events=True, background_color="#323233")
                        ],
                        [sg.Button(key=d, size=(10 ,1),) for d in self.currencies],
                        [
                            sg.Radio("Live Positions","radio_tracker", key="radio_live", default=True, background_color="#323233"),
                            sg.Radio("Long History","radio_tracker", key="radio_buy", background_color="#323233"),
                            sg.Radio("Short History", "radio_tracker", key="radio_sell", background_color="#323233"),
                            sg.Checkbox('Auto-scroll to End', default=True,key="autoscroll", background_color="#323233")
                        ],
                        [
                            sg.Text("Long", background_color="#323233"), 
                            sg.In("", key="long_total", size=(9,1), readonly=True), 
                            sg.Button("Close", size=(7, 1), key="-closeLong-"), 
                            sg.Text("Short", background_color="#323233"), 
                        ...
                        [sg.Table(values=data_values, headings=data_headings,
                                        ...
                                        row_height=28,
                                        font='Helvetica", 8', background_color="#323233")
                        ]
                ], background_color="#323233")
            ] #rows
        ]#layout
    ...
    def main_logic(self):
        ...
        # -----------------------------------------------
        # Create Main window with layout and
        # Initialize the Main logic variables,
        sg.theme_background_color("#323233")
        # window = sg.Window('Main Window', self.get_layout(), finalize=True, background_color="#323233", button_color=("#e1e1e1", '#1e1e1e'))                     # Initilalize the main window
        window = sg.Window('Main Window', self.get_layout(), finalize=True, button_color=("#e1e1e1", '#1e1e1e'))                     # Initilalize the main window
